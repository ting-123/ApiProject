<template>
  <div :class="b()" :style="heightStyleName" @keyup.enter="handleSend">
    <audio ref="chatAudio">
      <source :src="audio[0]" type="audio/ogg" />
      <source :src="audio[1]" type="audio/mpeg" />
      <source :src="audio[2]" type="audio/wav" />
    </audio>
    <div class="web__logo">
      <img :src="config.img" class="web__logo-img" alt="" />
    ...
    <div class="web__content">
      <div :style="widthStyleName">
        <div class="web__main" ref="main">
          ...
          >
            ...
            <div class="web__main-text">
              ...
              <ul class="web__main-list" v-if="!validatenull(item.text.list)">
                <li
        ...
        <div class="web__footer" :style="widthStyleName">
    ...
    >
      ...
      <span slot="footer" class="dialog-footer">
        <el-button @click="upload.box = false" size="small">取 消</el-button>
        <el-button type="primary" @click="uploadSubmit" size="small"
          >确 定</el-button
        >
      </span>
    </el-dialog>
